...
<div id="templatemo_container">
	<div id="templatemo_menu">
    	<ul>
            ...
            <li><a href="patientlog.jsp">In-Patient Login</a></li>
            <li><a href="outpatient.jsp">Out-Patient Details</a></li>
    ...
    <div id="templatemo_content">
        ...
        <div id="main_column">
                   ...
                   <td align="center"><font size="3">TIME</font></td>
                   <td align="center"><font size="3">STATUS</font></td>
              </tr>
<%               
    
    //pname, pid, ptype, mail, contact, age, sex, loc, issue, dname, tob, time, stat
        String pid=null,pname=null,ptype=null,mail=null,contact=null,age=null,sex=null,loc=null,issue=null,dname=null,nname=null,tob=null,time=null,stat=null;
        
Class.forName("com.mysql.cj.jdbc.Driver");	
Connection conn = DbConnector.getConnection();
Statement st1 = conn.createStatement();

ResultSet rs1 = st1.executeQuery("select * from  outpatient");
while(rs1.next()){
