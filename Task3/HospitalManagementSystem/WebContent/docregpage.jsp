...
<script>
    function check(){
        ...
        var d = document.ff.specialization.value;
    ...
    <div id="templatemo_content">
        ...
        <div id="main_column">
        	...
        	<div class="section_w560">
              ...
              <form action="regdocaction.jsp" name="ff"  method="get" onsubmit="return check()">
                    Name: <br><input type="text" name="doctorname" id="doctorname" style="background: cadetblue; height: 28px;  width:250px;"><br><br>
