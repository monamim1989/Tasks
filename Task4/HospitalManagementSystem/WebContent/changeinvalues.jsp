...
<script>
    function check(){
        ...
        var k = document.ff.nursename.value;
        var l = document.ff.totalbill.value;
        var m = document.ff.status.value;
        ...
        if (a==0){
	        ...
	        alert('Please Enter Staff In-charge');
    ...
    <div id="templatemo_content">
        ...
        <div id="main_column">
        	...
        	<div class="section_w560">
              ...
              <h4>Update In-Patient Information</h4>
              <form action="saveinchanges.jsp" name="ff"  method="get" onsubmit="return check()">
                    ...
                    Nurse Name:<br> <input type="text" name="nursename" id="nursename" style="background: cadetblue; height: 28px;  width:250px;"><br><br>
                    Total Bill:<br> <input type="text" name="totalbill" id="totalbill" style="background: cadetblue; height: 28px;  width:250px;"><br><br>
                    Status:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name ="status" id="status" style="background: cadetblue; height: 28px;  width:180px;"><option>Admitted</option>
