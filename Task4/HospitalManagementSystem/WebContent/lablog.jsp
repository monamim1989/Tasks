...
<div id="templatemo_container">
	<div id="templatemo_menu">
    	<ul>
            ...
            <li><a href="lablog.jsp">Lab Login</a></li>
    ...
    <div id="templatemo_content">
    	<img class="image_wrapper fl_image" src="img/templatemo_login.jpg" alt="image" /><br></br>
        
        <div id="main_column">
        
        	<div class="section_w560">
        	                   
              <h4>Medical Test Laboratory Login</h4>
              		<form action="labaction.jsp" name="ff"  method="get" onsubmit="return check()">
